...
import { MENTIONS_LEGALES } from "@/lib/i18n/mentionsLegales";

/**
 * Mentions légales (marché France).
 *
 * Page publique, atteignable depuis le pied de page — même emplacement et
 * même style de lien que /confidentialite. Contenu spécifique à la France
 * (LCEN) ; ne remplace pas /confidentialite, qui reste la politique de
 * confidentialité Tunisie.
 *
