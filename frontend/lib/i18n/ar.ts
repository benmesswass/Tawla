...
export const ar = {
  ...
  myShareTitle: "نصيبك",
  customAmountTitle: "إنتي تخلّص",
  amountModeMyShare: "نصيبي",
  amountModeWholeTable: "الطاولة الكل",
  amountModeCustom: "مبلغ آخر",
  customAmountLabel: (max) => `المبلغ اللي باش تخلّص (أقصى ${formatAmount(max)} د.ت)`,
  customAmountRemainingNote: (reste) => `باقي ${formatAmount(reste)} د.ت في هالكومند.`,
  customAmountInvalid: (max) => `أدخل مبلغ بين 0 و ${formatAmount(max)} د.ت.`,
