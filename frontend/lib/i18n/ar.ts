...
export const ar = {
  ...
  paidByPerson: (name) => `${name} خلص نصيبو`,
  remainingAmountLabel: "باقي تخلص :",
  myShareTitle: "نصيبك",
  myShareAlreadyPaidMessage: "خلصت نصيبك — يعطيك الصحة !",
  ...
  repartitionSectionTitle: "التقسيمة",
  shareBillCardTitle: "قسمة الفاتورة",
  shareBillHelper: "قسّم هاذي الطلبية مع بقية الناس اللي معاك على الطاولة.",
  totalOrderAmountNote: (amount) => `على فاتورة جملتها ${formatAmount(amount)} د.ت`,
  splitModeEqual: "بالتساوي",
  splitModeByItem: "بالأكلة",
  sharedOption: "للقسمة",
  personLabel: (n) => `شخص ${n}`,
  unassignedSharedNote: "الأكلات إلي ما تعيّنتش تتقسم بالتساوي.",
  equalSplitNote: "كل واحد يخلص نفس المبلغ، بصرف النظر على شنوة طلب.",

  identityPromptTitle: "سميتك",
  identityPromptSubtitle: "باش تبقى معلقة في أكلاتك لحد الخلاص — نافعة باش تقسموا الفاتورة في الآخر.",
  identityInputPlaceholder: "Perso1",
  identityInputCaption: "خليتها فارغة، باش تبقى « Perso1 ».",
  identityContinue: "كمّل",
  identityPromptSkip: "تخطي",
  rosterSectionTitle: "في الطاولة",
  rosterYouTag: (name) => `إنتي · ${name}`,
  rosterAddGuestChip: "+ زيد",
