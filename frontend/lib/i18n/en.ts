...
export const en = {
  ...
  paidByPerson: (name: string) => `${name} paid their share`,
  remainingAmountLabel: "Remaining to pay:",
  myShareTitle: "Your share",
  customAmountTitle: "You pay",
  amountModeMyShare: "My share",
  amountModeWholeTable: "Whole table",
  amountModeCustom: "Other amount",
  customAmountLabel: (max: number) => `Amount to pay (up to ${formatMoney(max)})`,
  customAmountRemainingNote: (reste: number) => `${formatMoney(reste)} left to pay on this order.`,
  customAmountInvalid: (max: number) => `Enter an amount between 0 and ${formatMoney(max)}.`,
  myShareAlreadyPaidMessage: "You've paid your share — thank you!",
  ...
  identityPromptSubtitle:
    "It follows your dishes all the way to payment — handy for splitting the bill at the end.",
  identityInputPlaceholder: "Perso1",
  identityInputCaption: "Left blank, you'll stay « Perso1 ».",
  identityContinue: "Continue",
  identityPromptSkip: "Skip",
  rosterSectionTitle: "At the table",
  rosterYouTag: (name: string) => `You · ${name}`,
  rosterAddGuestChip: "+ Add",
