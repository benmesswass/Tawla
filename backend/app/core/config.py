...
class Settings(BaseSettings):
    ...
    # Marché servi par CE déploiement (voir app/core/markets.py) — jamais une
    # bascule par requête, un déploiement sert un seul marché
    # (MARCHE_FRANCE.md §4). "tn" par défaut : ne rien poser en Tunisie ne
    # doit rien changer au comportement actuel.
    market: str = "tn"
