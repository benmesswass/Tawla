...
- [ ] **A4 — TVA multi-taux** : `MenuItem.vat_rate`, migration, ventilation HT/TVA/TTC par article — aujourd'hui un taux UNIQUE (`sur_place`, 10 %) appliqué à toute la note (`core/invoice.py`), faux dès qu'une table commande de l'alcool (20 %) ou de la vente à emporter (5,5 %)
- [x] Détail des articles, prix unitaire, totaux HT/TVA/TTC (au taux unique ci-dessus, en attendant A4) — déjà livré (PR #142, PR #143)
...
- [ ] Reste ouvert : la note n'est **entièrement** conforme (art. 289 CGI / arrêté du 3 octobre 1983) qu'une fois A4 livré — la ventilation à taux unique ci-dessus est fausse pour toute commande mêlant plusieurs taux
